...
export type HealthGoal = 'energy' | 'sleep_recovery' | 'metabolism' | 'longevity_prevention' | 'performance';
...
export type TimelineEventType = 'lab_upload' | 'check_in' | 'goal_change' | 'recommendation_generated' | 'weekly_review';
